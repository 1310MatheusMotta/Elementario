...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Dez-2021 às 18:12
...
('Sara Dourado', 77, 9, 22, 0, 0, 0),
('Antonio', 78, 14, 2, 0, 0, 0),
('Antonio Salo', 79, 6, 2, 0, 0, 0);
...
('Teste de Geografia', '2021-12-03', 28, 9, 15, 3, 26, 1, 4, 0),
('Teste Matemática 3ADM', '2021-12-17', 30, 6, 11, 3, 27, 1, 5, 0),
('Teste', '2021-12-23', 31, 6, 11, 3, 24, 1, 4, 0);
...
--
ALTER TABLE `alunos`
  MODIFY `id_alu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `avaliacao`
  MODIFY `codigo_ava` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de tabela `disciplinas`
--
ALTER TABLE `disciplinas`
  MODIFY `codigo_dis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `instituicao`
--
ALTER TABLE `instituicao`
  MODIFY `codigo_ins` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `turmas`
  MODIFY `codigo_tur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
